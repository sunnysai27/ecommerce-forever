  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        ...
        >
          <p className="test-sm font-medium mb-3">CATEGORIES</p>
          <div className="flex flex-col text-sm gap-2 font-light text-gray-700 py-5">
        ...
        >
          <p className="test-sm font-medium mb-3">TYPES</p>
